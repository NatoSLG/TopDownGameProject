...
public abstract class SpawnData : ScriptableObject
{
    ...
    public GameObject[] possibleSpawnPrefab = new GameObject[1];
    ...
    /*Returns an array of prefabs that should spawn.
     Takes an optional perameter of how many enemies are on the screen at the moment.*/
    public virtual GameObject[] GetSpawns(int totalEnemies = 0)
    {
        ...
        {
            /*Randomly picks one of the possible spawns
             and inserts it into the result array.*/
    ...
    //Get a random spawn interval between the min and max value.
