...
public class PorjectileWeapon : Weapon
{
    ...
    protected override bool Attack(int attackCount = 1)
    {
        ...
        //reset the cooldown only if the attack was triggered by cooldown
    ...
    {
        return Quaternion.Euler(0, 0, spawnAngle) *
            new Vector2(Random.Range(currentStats.spawnVariance.xMin, currentStats.spawnVariance.xMax),
